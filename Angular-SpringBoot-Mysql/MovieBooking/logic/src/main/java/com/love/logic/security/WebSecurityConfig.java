package com.love.logic.security;
...
import com.love.logic.security.jwt.AuthEntryPointJwt;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable()
      ...
      .authorizeRequests().antMatchers("/petproject/auth/**").permitAll()
      .antMatchers("/movie/enquiry/**").permitAll()
      .antMatchers("/movie/getMovieforTdy/**").permitAll()
